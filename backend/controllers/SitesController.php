...
class SitesController extends Controller
{
    ...
    public function actionExportPdf()
    {
        $searchModel = new SiteSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        return CashewAppHelper::renderPDF($this->renderPartial('_pdf', ['dataProvider' => $dataProvider, 'showCompany' => Yii::$app->user->identity->company_id  == null]), Pdf::FORMAT_A4, Pdf::ORIENT_PORTRAIT, '.kv-heading-1{font-size:18px}', ['marginTop' => '15px','marginLeft' => '10px','marginRight' => '10px','marginBottom' => '15px'], "sites_" .date('Y_m_d-H_i_s', strtotime('now')). ".pdf");
    }
}
