...
$this->registerJs("
        ...
        Highcharts.mapChart('map-container', {
            ...
            title: {
                text: 'Heatmap for KOR Average per region'
            },
            ...
            tooltip: {
                header: '',
                pointFormat: 'Region: <b>{point.name}</b><br>Lat: <b>{point.properties.latitude}</b>, Lon: <b>{point.properties.longitude}</b><br>KOR: <b>{point.properties.postal-code}</b>'
            },
...
$this->registerJs("
    ...
    Highcharts.chart('map-container3', {
        ...
        title: {
            text: 'KOR Average per region per week'
        },
