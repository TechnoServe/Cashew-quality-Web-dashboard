    ...
    <div class="panel-body">
        ...
        <div class="pad-ver mar-btm">
            <div class="btn-group btn-group-justified">
                <?=Html::a(Yii::t("app", "This week"), [$url, "predefinedPeriod" => 1], ["class"=>"btn  btn-primary text-bold"])?>
                <?=Html::a(Yii::t("app", "This month"), [$url, "predefinedPeriod" => 2], ["class"=>"btn  btn-info text-bold"])?>
                <?=Html::a(Yii::t("app", "This quarter"), [$url, "predefinedPeriod" => 3], ["class"=>"btn  btn-warning text-bold"])?>
                <?=Html::a(Yii::t("app", "This year"), [$url, "predefinedPeriod" => 4], ["class"=>"btn  btn-mint text-bold"])?>
            </div>
        </div>
    </div>
</div>
